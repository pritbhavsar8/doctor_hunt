...
class find_doctorScreen extends StatefulWidget {
  const find_doctorScreen({Key? key}) : super(key: key);

  @override
  State<find_doctorScreen> createState() => _find_doctorScreenState();
}

class _find_doctorScreenState extends State<find_doctorScreen> {
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            child: Image.asset("img/like.png",width: 19.0,height: 17.0,color: color,)
                                          ),
                                        ),
                                        Padding(
                                      ...
                                      children: [
                                        ...
                                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Padding(
                                              padding: const EdgeInsets.only(left: 10.0),
                                              child: Text("Dr.Watamaniuk",style: TextStyle(
                                                  fontFamily: "Rubik",
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Padding(
                                              padding: const EdgeInsets.only(left: 10.0),
                                              child: Text("Dr. Crownover",style: TextStyle(
                                                  fontFamily: "Rubik",
                                                  fontWeight: FontWeight.w700,
                                                  fontSize: 18.0,
                                                  color: Color(0xff333333)
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Padding(
                                              padding: const EdgeInsets.only(left: 10.0),
                                              child: Text("Dr. Balestra",style: TextStyle(
                                                  fontFamily: "Rubik",
                                                  fontWeight: FontWeight.w700,
                                                  fontSize: 18.0,
                                                  color: Color(0xff333333)
